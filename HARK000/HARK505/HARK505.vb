...
Public Class HARK505
    ...
    Private Sub Set_CmbValue()
        ...
        Try
            ...
            'PHsmos医療機関一覧取得
            If DLTP0505_PROC0020(xxxstrProgram_ID, gintSPDシステムコード, 0, gintSQLCODE, gstrSQLERRM) = False Then
            ...
            'PHsmos医療機関一覧
            For i = 0 To gintPHsmos医療機関Cnt - 1

                cmb医療機関.Items.Add(New PHsmos医療機関一覧(PHsmos医療機関Array(i).str医療機関名, PHsmos医療機関Array(i).str医療機関コード))

            Next

            '空白行追加
            cmb医療機関.Items.Add(New PHsmos医療機関一覧("", ""))
    ...
    Private Sub Initialize()
        ...
        Try
            ...
            cmb医療機関.SelectedIndex = gintPHsmos医療機関Cnt
        ...
        Try
            ...
            Select Case Tag
                ...
                Case "ID2" '医療機関
                    ...
                    With DirectCast(cmb医療機関.SelectedItem, PHsmos医療機関一覧)
    ...
    Private Function 実行前チェック処理() As Boolean
        ...
        Try
            ...
            'PHsmos医療機関チェック
            If IsNull(cmb医療機関.Text.Trim) = True Then
    ...
    Private Function データ検索処理() As Boolean
        ...
        Try
            ...
            Select Case xxxintSubProgram_ID
                ...
                Case 2 '更新日付が下記以降の得商/需商を対象とする
                    gintRtn = DLTP0505_PROC0001(xxxstrProgram_ID, gintSPDシステムコード, xxxintSubProgram_ID, xxxstr医療機関コード, txtDate.Text.Trim, gintSQLCODE, gstrSQLERRM)
