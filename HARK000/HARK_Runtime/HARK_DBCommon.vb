...
Public Class HARK_DBCommon
    ...
    Public Shared Function DLTP0900_PROC0001(ByVal PI_strProgram_ID As String,
        ...
        Try
            ...
            Else
                ...
                If PO_intSQLCODE <> 1 Then log.Error(Set_ErrMSG(PO_intSQLCODE, PO_strSQLERRM))
    ...
    Public Shared Function DLTP0900_PROC0003(ByVal PI_strProgram_ID As String,
        ...
        Try
            ...
            Else
                ...
                If PO_intSQLCODE <> 9 Then log.Error(Set_ErrMSG(PO_intSQLCODE, PO_strSQLERRM))
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0202_PROC0001(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByVal PI_需要先コード As Long,
                                             ByRef PO_intSQLCODE As Integer,
    ...
    '''' <param name="PI_int取込除外">取込除外</param>
    '''' <param name="PO_intSQLCODE">Oracleエラーコード（戻値）</param>
    '''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    '''' <returns>0 -- 正常終了、2 -- データなし、9 -- 異常終了</returns>
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 9 -- エラー</returns>
    Public Shared Function DLTP0202_PROC0003(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByRef PO_intSQLCODE As Integer,
                                             ByRef PO_strSQLERRM As String) As Integer
    ...
    Public Shared Function DLTP0401_PROC0002(ByVal PI_strProgram_ID As String,
                                             ...
                                             ByVal PI_ワーク初期化区分 As Integer,
                                             ByVal PI_明細識別区分 As Integer,
                                             ByRef PO_intCnt0 As Integer,
                                             ByRef PO_intCnt1 As Integer,
                                             ByRef PO_intCnt2 As Integer,
                                             ByRef PO_intSQLCODE As Integer,
        ...
        Try
            ...
            PI_06.Value = PI_ワーク初期化区分
            PI_07.Value = PI_明細識別区分
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0401_PROC0013(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByRef PO_intSQLCODE As Integer,
                                             ByRef PO_strSQLERRM As String) As Integer
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0100S_PROC0023(ByVal PI_strProgram_ID As String,
                                              ByVal PI_intSPDSystemcode As Integer,
                                              ByVal PI_intSubProgram_ID As Integer,
                                              ByVal PI_lng得意先コード As Long,
                                              ByVal PI_lng需要先コード As Long,
        ...
        Try
            DLTP0100S_PROC0023 = 9
            gintResultCnt = 0

            'プログラム_ID取得
            gintRtn = DLTP0997S_FUNC005("HARKP100S", 0, 0, 3, 1, "処理関数")
            strPROC = gstrDLTP0997S_FUNC005

            '項目数取得
            gintRtn = DLTP0997S_FUNC004("HARKP100S", 0, 0, 3, 99, "項目数")
            ColMax = gintDLTP0997S_FUNC004
            ...
            Select Case PO_intSQLCODE
                ...
                Case 2
                    ...
                    DLTP0100S_PROC0023 = 2
                    OraTran.Rollback()
                    Exit Function

                Case -54 'NOWAIT ビジー

                    DLTP0100S_PROC0023 = -54
                    OraTran.Rollback()
                    Exit Function
    ...
    ''' <param name="PI_intSubProgram_ID">サブプログラム_ID</param>
    ''' <param name="PI_intSPDSystemcode">SPDシステムコード</param>
    ''' <param name="PI_int新規区分">新規区分</param>
    ''' <param name="PI_lng得意先コード">得意先コード</param>
    ''' <param name="PI_lng需要先コード">需要先コード</param>
    ''' <param name="PI_int直送区分">直送区分</param>
    ''' <param name="PI_int商品出荷指示区分">商品出荷指示区分</param>
    ''' <param name="PI_int商品手配方法区分">商品手配方法区分</param>
    ''' <param name="PI_int発注納期設定区分">発注納期設定区分</param>
    ''' <param name="PI_lng直送先コード">直送先コード</param>
    ''' <param name="PI_str発注納期曜日_月">発注納期曜日_月</param>
    ''' <param name="PI_str発注納期曜日_火">発注納期曜日_火</param>
    ''' <param name="PI_str発注納期曜日_水">発注納期曜日_水</param>
    ''' <param name="PI_str発注納期曜日_木">発注納期曜日_木</param>
    ''' <param name="PI_str発注納期曜日_金">発注納期曜日_金</param>
    ''' <param name="PO_intSQLCODE">Oracleエラーコード（戻値）</param>
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常終了、2 -- データなし、9 -- 異常終了 </returns>
    Public Shared Function DLTP0100S_PROC0024(ByVal PI_strProgram_ID As String,
                                              ByVal PI_intSubProgram_ID As Integer,
                                              ByVal PI_intSPDSystemcode As Integer,
                                              ByVal PI_int新規区分 As Integer,
                                              ByVal PI_lng得意先コード As Long,
                                              ByVal PI_lng需要先コード As Long,
                                              ByVal PI_int直送区分 As Integer,
                                              ByVal PI_int商品出荷指示区分 As Integer,
                                              ByVal PI_int商品手配方法区分 As Integer,
                                              ByVal PI_int発注納期設定区分 As Integer,
                                              ByVal PI_lng直送先コード As Long,
                                              ByVal PI_str発注納期曜日_月 As String,
                                              ByVal PI_str発注納期曜日_火 As String,
                                              ByVal PI_str発注納期曜日_水 As String,
                                              ByVal PI_str発注納期曜日_木 As String,
                                              ByVal PI_str発注納期曜日_金 As String,
                                              ByRef PO_intSQLCODE As Integer,
                                              ByRef PO_strSQLERRM As String) As Integer
        ...
        Try
            DLTP0100S_PROC0024 = 9

            'プログラム_ID取得
            gintRtn = DLTP0997S_FUNC005("HARKP100S", 0, 0, 1, 1, "処理関数")
            strPROC = gstrDLTP0997S_FUNC005
            ...
            If PI_int新規区分 = 1 Then OraTran = Oracomm.BeginTransaction
            ...
            PI_07 = Oracmd.Parameters.Add("PI_07", OracleDbType.Int32, ParameterDirection.Input)
            PI_08 = Oracmd.Parameters.Add("PI_08", OracleDbType.Int32, ParameterDirection.Input)
            PI_09 = Oracmd.Parameters.Add("PI_09", OracleDbType.Int64, ParameterDirection.Input)
            PI_10 = Oracmd.Parameters.Add("PI_10", OracleDbType.Varchar2, ParameterDirection.Input)
            PI_11 = Oracmd.Parameters.Add("PI_11", OracleDbType.Varchar2, ParameterDirection.Input)
            PI_12 = Oracmd.Parameters.Add("PI_12", OracleDbType.Varchar2, ParameterDirection.Input)
            PI_13 = Oracmd.Parameters.Add("PI_13", OracleDbType.Varchar2, ParameterDirection.Input)
            PI_14 = Oracmd.Parameters.Add("PI_14", OracleDbType.Varchar2, ParameterDirection.Input)
            ...
            PI_03.Value = PI_lng得意先コード
            PI_04.Value = PI_lng需要先コード
            PI_05.Value = PI_int直送区分
            PI_06.Value = PI_int商品出荷指示区分
            PI_07.Value = PI_int商品手配方法区分
            PI_08.Value = PI_int発注納期設定区分
            PI_09.Value = PI_lng直送先コード
            PI_10.Value = PI_str発注納期曜日_月
            PI_11.Value = PI_str発注納期曜日_火
            PI_12.Value = PI_str発注納期曜日_水
            PI_13.Value = PI_str発注納期曜日_木
            PI_14.Value = PI_str発注納期曜日_金
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常終了、2 -- データなし、9 -- 異常終了 </returns>
    Public Shared Function DLTP0101_PROC0031(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_str商品コード As String,
                                             ByRef PO_intSQLCODE As Integer,
        ...
        Try
            ...
            Select Case PO_intSQLCODE
                ...
                Case 7, 8
                    DLTP0101_PROC0031 = PO_intSQLCODE
                    Exit Function
                Case Else
                    log.Error(Set_ErrMSG(PO_intSQLCODE, PO_strSQLERRM))
                    Exit Function
    ...
    ''' <param name="PI_int出荷連携">出荷連携</param>
    ''' <param name="PI_int取込除外">取込除外</param>
    ''' <param name="PI_int振替除外">振替除外</param>
    ''' <param name="PO_intSQLCODE">Oracleエラーコード（戻値）</param>
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常終了、2 -- データなし、9 -- 異常終了</returns>
    Public Shared Function DLTP0101_PROC0032(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_str商品コード As String,
                                             ByVal PI_strSPD商品コード As String,
        ...
        Try
            ...
            If Math.Abs(PO_intSQLCODE) > 0 Then
                OraTran.Rollback()
                log.Error(Set_ErrMSG(PO_intSQLCODE, PO_strSQLERRM))
                DLTP0101_PROC0032 = PO_intSQLCODE
                Exit Function
            End If
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）></param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0201_PROC0031(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_str連携キー As String,
                                             ByRef PO_intSQLCODE As Integer,
        ...
        Try
            ...
            Select Case PO_intSQLCODE
                ...
                Case 7, 8
                    DLTP0201_PROC0031 = PO_intSQLCODE
                    Exit Function
                Case Else
                    log.Error(Set_ErrMSG(PO_intSQLCODE, PO_strSQLERRM))
                    Exit Function
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）></param>
    ''' <returns>True・・正常終了、False・・異常終了</returns>
    Public Shared Function DLTP0201_PROC0032(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_str連携キー As String,
                                             ByRef PO_intSQLCODE As Integer,
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0100S_PROC0025(ByVal PI_strProgram_ID As String,
                                              ByVal PI_intSPDSystemcode As Integer,
                                              ByVal PI_intSubProgram_ID As Integer,
                                              ByVal PI_str商品コード As String,
                                              ByVal PI_str相手先賞品コード As String,
                                              ByVal PI_lng得意先コード As Long,
                                              ByVal PI_lng需要先コード As Long,
                                              ByRef PO_intSQLCODE As Integer,
                                              ByRef PO_strSQLERRM As String) As Integer
        ...
        Try
            DLTP0100S_PROC0025 = 9
            gintResultCnt = 0

            'プログラム_ID取得
            gintRtn = DLTP0997S_FUNC005("HARKP100S", 0, 1, 3, 1, "処理関数")
            strPROC = gstrDLTP0997S_FUNC005

            '項目数取得
            gintRtn = DLTP0997S_FUNC004("HARKP100S", 0, 1, 3, 99, "項目数")
            ColMax = gintDLTP0997S_FUNC004
            ...
            PI_05 = Oracmd.Parameters.Add("PI_05", OracleDbType.Varchar2, ParameterDirection.Input)
            PI_06 = Oracmd.Parameters.Add("PI_06", OracleDbType.Int64, ParameterDirection.Input)
            PI_07 = Oracmd.Parameters.Add("PI_07", OracleDbType.Int64, ParameterDirection.Input)
            ...
            PI_03.Value = PI_intSubProgram_ID
            PI_04.Value = PI_str商品コード
            PI_05.Value = PI_str相手先賞品コード
            If PI_lng得意先コード = DUMMY_LNGCODE Then
                PI_06.Value = vbNullString
            Else
                PI_06.Value = PI_lng得意先コード
            End If
            If PI_lng需要先コード = DUMMY_LNGCODE Then
                PI_07.Value = vbNullString
            Else
                PI_07.Value = PI_lng需要先コード
            End If
            ...
            Select Case PO_intSQLCODE
                ...
                Case 2
                    ...
                    DLTP0100S_PROC0025 = 2
                    OraTran.Rollback()
                    Exit Function

                Case -54 'NOWAIT ビジー

                    DLTP0100S_PROC0025 = -54
                    OraTran.Rollback()
                    Exit Function
    ...
    ''' <param name="PI_int新規区分">新規区分</param>
    ''' <param name="PI_str商品コード">商品コード</param>
    ''' <param name="PI_str相手先賞品コード">相手先賞品コード</param>
    ''' <param name="PI_lng得意先コード">得意先コード</param>
    ''' <param name="PI_lng需要先コード">需要先コード</param>
    ''' <param name="PI_lngID">DLTSPD商品変換マスタ_ID</param>
    ''' <param name="PO_intSQLCODE">Oracleエラーコード（戻値）</param>
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常終了、2 -- データなし、9 -- 異常終了 </returns>
    Public Shared Function DLTP0100S_PROC0026(ByVal PI_strProgram_ID As String,
                                              ByVal PI_intSubProgram_ID As Integer,
                                              ByVal PI_intSPDSystemcode As Integer,
                                              ByVal PI_int新規区分 As Integer,
                                              ByVal PI_str商品コード As String,
        ...
        Try
            DLTP0100S_PROC0026 = 9

            'プログラム_ID取得
            gintRtn = DLTP0997S_FUNC005("HARKP100S", 0, 1, 1, 1, "処理関数")
            strPROC = gstrDLTP0997S_FUNC005
            ...
            PI_06 = Oracmd.Parameters.Add("PI_06", OracleDbType.Int64, ParameterDirection.Input)
            PI_07 = Oracmd.Parameters.Add("PI_07", OracleDbType.Int64, ParameterDirection.Input)
            PI_08 = Oracmd.Parameters.Add("PI_08", OracleDbType.Int64, ParameterDirection.Input)

            'インプット値設定
            PI_01.Value = My.Settings.事業所コード
            PI_02.Value = PI_intSPDSystemcode
            PI_03.Value = PI_intSubProgram_ID
            If PI_str商品コード = DUMMY_STRNULL Then
                PI_04.Value = vbNullString
            Else
                PI_04.Value = PI_str商品コード
            End If
            If PI_str相手先賞品コード = DUMMY_STRNULL Then
                PI_05.Value = vbNullString
            Else
                PI_05.Value = PI_str相手先賞品コード
            End If
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>True -- 正常取得 False -- エラー</returns>
    Public Shared Function DLTP0107_PROC0020(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByRef PO_intSQLCODE As Integer,
                                             ByRef PO_strSQLERRM As String) As Boolean
        ...
        Try
            DLTP0107_PROC0020 = False

            gintサブプログラムCnt = 0

            'ストアドプロシージャ設定
            Oracmd = Oracomm.CreateCommand()
            Oracmd.CommandText = "DLTP0107.PROC0020"
            Oracmd.CommandType = CommandType.StoredProcedure
            ...
            'インプット値設定
            PI_01.Value = PI_intSPDSystemcode
            PI_02.Value = My.Settings.事業所コード
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 9 -- エラー</returns>
    Public Shared Function DLTP0107_PROC0001(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByRef PO_intNo As Integer,
                                             ByRef PO_intCnt0 As Integer,
    ...
    ''' <param name="PI_lng得意先コード">得意先コード</param>
    ''' <param name="PI_lng需要先コード">需要先コード</param>
    ''' <param name="PI_int単価区分">単価区分</param>
    ''' <param name="PO_intSQLCODE">Oracleエラーコード（戻値）</param>
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0506_PROC0001(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByVal PI_lng得意先コード As Long,
                                             ByVal PI_lng需要先コード As Long,
                                             ByVal PI_int単価区分 As Integer,
                                             ByRef PO_intSQLCODE As Integer,
                                             ByRef PO_strSQLERRM As String) As Integer
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 9 -- エラー</returns>
    Public Shared Function DLTP0501_PROC0031(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByRef PO_intSQLCODE As Integer,
                                             ByRef PO_strSQLERRM As String) As Integer
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0501_PROC0032(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByRef PO_intSQLCODE As Integer,
                                             ByRef PO_strSQLERRM As String) As Integer
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 9 -- エラー</returns>
    Public Shared Function DLTP0107_PROC0028(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_lng作成担当者コード As Long,
                                             ByVal PI_int取込番号 As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
        ...
        Try
            ...
            PI_03 = Oracmd.Parameters.Add("PI_03", OracleDbType.Int32, ParameterDirection.Input)
            PI_04 = Oracmd.Parameters.Add("PI_04", OracleDbType.Int32, ParameterDirection.Input)
            PI_05 = Oracmd.Parameters.Add("PI_04", OracleDbType.Int32, ParameterDirection.Input)
    ...
    ''' <param name="PO_strSQLERRM">Oracleエラーメッセージ（戻値）</param>
    ''' <returns>0 -- 正常取得 2 -- レコード無 9 -- エラー</returns>
    Public Shared Function DLTP0301_PROC0018(ByVal PI_strProgram_ID As String,
                                             ByVal PI_intSPDSystemcode As Integer,
                                             ByVal PI_intSubProgram_ID As Integer,
                                             ByRef PO_intSQLCODE As Integer,
                                             ByRef PO_strSQLERRM As String) As Integer
