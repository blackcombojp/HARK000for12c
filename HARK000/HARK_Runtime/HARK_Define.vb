...
Module HARK_Define
    ...
    Public Const MSG_301048 As String = "需要先を選択してください"
    ...
    Public Const MSG_401007 As String = "値引金額確認表出力中"
    Public Const MSG_401008 As String = "値引作成処理は異常終了しました"
    Public Const MSG_401009 As String = "値引作成処理は正常終了しました"
    Public Const MSG_401010 As String = "値引金額確認表作成処理は異常終了しました"
    Public Const MSG_401011 As String = "値引金額確認表作成処理は正常終了しました"
    Public Const MSG_401012 As String = "値引作成処理中"
    ...
    Public Const MSG_501005 As String = "部署コードの指定が不正です"
    Public Const MSG_501006 As String = "指定された部署は存在しません"
    Public Const MSG_501007 As String = "部署コードを指定してください"
    Public Const MSG_501008 As String = "部署名を入力してください"
    Public Const MSG_501009 As String = "施設を指定してください"
    Public Const MSG_501010 As String = "部署コードを入力してください"
    Public Const MSG_501011 As String = "処理は正常終了しました"
    Public Const MSG_501012 As String = "処理は異常終了しました"
    Public Const MSG_501013 As String = "指定の部署コードは既に存在します"
    Public Const MSG_501014 As String = "指定の部署コードは他の端末で表示中です"
    Public Const MSG_501015 As String = "院内コードを指定してください"
    Public Const MSG_501016 As String = "院内コードの指定が不正です"
    Public Const MSG_501017 As String = "指定した院内コードは商品マスタに存在しません"
    Public Const MSG_501018 As String = "指定した院内コードは他の端末で表示中です"
    Public Const MSG_501019 As String = "採用商品マスタ業者名付ファイルを指定してください"
    Public Const MSG_501020 As String = "検索日を指定してください"
    ...
    Public Const MSG_502008 As String = "対象外は選択できません"
